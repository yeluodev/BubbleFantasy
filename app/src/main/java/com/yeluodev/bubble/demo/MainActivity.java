package com.yeluodev.bubble.demo;
...
import com.yeluo.lib.bubble.config.ClipPathCreator;
...
public class MainActivity extends AppCompatActivity {
    ...
    @BubbleType
    private int mBubbleType = BubbleType.TYPE_BUBBLE_LEFT;
    @PositionType
    private int mArrowType = PositionType.TYPE_POSITION_LEFT;
    ...
    private String mImgUrl = "https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3177576178,2545239630&fm=26&gp=0.jpg";
    ...
    private void calculateArrowAttrs(int width, int height) {
        int temp;
        if (mBubbleType == BubbleType.TYPE_BUBBLE_LEFT || mBubbleType == BubbleType.TYPE_BUBBLE_RIGHT) {
            temp = width;
            width = height;
            height = temp;
        }
        do {
            ...
            switch (mBubbleType) {
                case BubbleType.TYPE_BUBBLE_LEFT:
                    mArrowOffsetMin = mArrowType == PositionType.TYPE_POSITION_LEFT ? mLeftBottomCornerRadius : mLeftTopCornerRadius;
                ...
                case BubbleType.TYPE_BUBBLE_RIGHT:
                    mArrowOffsetMin = mArrowType == PositionType.TYPE_POSITION_LEFT ? mRightTopCornerRadius : mRightBottomCornerRadius;
                ...
                case BubbleType.TYPE_BUBBLE_TOP:
                    mArrowOffsetMin = mArrowType == PositionType.TYPE_POSITION_LEFT ? mLeftTopCornerRadius : mRightTopCornerRadius;
                ...
                case BubbleType.TYPE_BUBBLE_BOTTOM:
                    mArrowOffsetMin = mArrowType == PositionType.TYPE_POSITION_LEFT ? mRightBottomCornerRadius : mLeftBottomCornerRadius;
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(mImgUrlEditText.getText())) {
                    mImgUrl = "https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3177576178,2545239630&fm=26&gp=0.jpg";
                } else {
