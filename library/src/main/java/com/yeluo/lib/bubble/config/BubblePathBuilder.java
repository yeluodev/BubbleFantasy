...
public class BubblePathBuilder {
    ...
    /**
     * 针对mArrowType为{@link PositionType#TYPE_POSITION_LEFT}和{@link PositionType#TYPE_POSITION_RIGHT}的情况
     * 在{@link PositionType#TYPE_POSITION_LEFT}情况下, mArrowOffset为箭头左侧到左侧边界的距离
     * 在{@link PositionType#TYPE_POSITION_RIGHT}情况下, mArrowOffset为箭头右侧到右侧边界的距离
     */
    private float mArrowOffset = 100;
    /**
     * 想象一下, 你站在中心点, 正对着箭头所在的边的方向, 这个时候箭头在你的那个位置?
     * 左手边{@link PositionType#TYPE_POSITION_LEFT},
     * 正前面{@link PositionType#TYPE_POSITION_CENTER},
     * 右手边{@link PositionType#TYPE_POSITION_RIGHT}
     */
    private int mArrowType = PositionType.TYPE_POSITION_CENTER;
    /**
     * 箭头所在边的位置
     * 左边{@link BubbleType#TYPE_BUBBLE_LEFT},
     * 顶部{@link BubbleType#TYPE_BUBBLE_TOP},
     * 右边{@link BubbleType#TYPE_BUBBLE_RIGHT}
     * 底部{@link BubbleType#TYPE_BUBBLE_BOTTOM}
     */
    private int mBubbleType = BubbleType.TYPE_BUBBLE_BOTTOM;
     ...
     * 箭头摆放位置
     *
     * @param type 左手边{@link PositionType#TYPE_POSITION_LEFT}
     *             正前面{@link PositionType#TYPE_POSITION_CENTER}
     *             右手边{@link PositionType#TYPE_POSITION_RIGHT}
     * @return builder
     */
     ...
     * 气泡箭头的所在边位置
     *
     * @param type 左边{@link BubbleType#TYPE_BUBBLE_LEFT}
     *             顶部{@link BubbleType#TYPE_BUBBLE_TOP}
     *             右边{@link BubbleType#TYPE_BUBBLE_RIGHT}
     *             底部{@link BubbleType#TYPE_BUBBLE_BOTTOM}
     * @return builder
    ...
    private Path generateBubblePath() {
        mClipPath.reset();
        switch (mBubbleType) {
            case BubbleType.TYPE_BUBBLE_LEFT: {
                createLeftArrowPath();
                break;
            }
            case BubbleType.TYPE_BUBBLE_TOP: {
                createTopArrowPath();
                break;
            }
            case BubbleType.TYPE_BUBBLE_RIGHT: {
                createRightArrowPath();
                break;
            }
            case BubbleType.TYPE_BUBBLE_BOTTOM: {
    ...
    private void createLeftArrowPath() {
        ...
        mClipPath.arcTo(new RectF(mBubbleWidth - mRightTopCornerRadius * 2, 0, mBubbleWidth, mRightTopCornerRadius * 2), -90, 90, false);
        mClipPath.lineTo(mBubbleWidth, mBubbleHeight - mRightBottomCornerRadius);
        mClipPath.arcTo(new RectF(mBubbleWidth - mRightBottomCornerRadius * 2, mBubbleHeight - mRightBottomCornerRadius * 2, mBubbleWidth, mBubbleHeight), 0, 90, false);
        mClipPath.lineTo(mLeftBottomCornerRadius + mArrowHeight, mBubbleHeight);
        mClipPath.arcTo(new RectF(mArrowHeight, mBubbleHeight - mLeftBottomCornerRadius * 2, mArrowHeight + mLeftBottomCornerRadius * 2, mBubbleHeight), 90, 90, false);
        ...
        mClipPath.arcTo(new RectF(mArrowHeight, 0, mArrowHeight + mLeftTopCornerRadius * 2, mLeftTopCornerRadius * 2), 180, 90, false);
        mClipPath.close();
    }
    ...
    private void createTopArrowPath() {
        ...
        mClipPath.arcTo(new RectF(mBubbleWidth - mRightTopCornerRadius * 2, mArrowHeight, mBubbleWidth, mArrowHeight + mRightTopCornerRadius * 2), -90, 90, false);
        mClipPath.lineTo(mBubbleWidth, mBubbleHeight - mRightBottomCornerRadius);
        mClipPath.arcTo(new RectF(mBubbleWidth - mRightBottomCornerRadius * 2, mBubbleHeight - mRightBottomCornerRadius * 2, mBubbleWidth, mBubbleHeight), 0, 90, false);
        mClipPath.lineTo(mLeftBottomCornerRadius, mBubbleHeight);
        mClipPath.arcTo(new RectF(0, mBubbleHeight - mLeftBottomCornerRadius * 2, mLeftBottomCornerRadius * 2, mBubbleHeight), 90, 90, false);
        mClipPath.lineTo(0, mLeftTopCornerRadius + mArrowHeight);
        mClipPath.arcTo(new RectF(0, mArrowHeight, mLeftTopCornerRadius * 2, mArrowHeight + mLeftTopCornerRadius * 2), 180, 90, false);
        mClipPath.close();
    }
    ...
    private void createRightArrowPath() {
        ...
        mClipPath.arcTo(new RectF(mBubbleWidth - mRightTopCornerRadius * 2 - mArrowHeight, 0, mBubbleWidth - mArrowHeight, mRightTopCornerRadius * 2), -90, 90, false);
        ...
        mClipPath.arcTo(new RectF(mBubbleWidth - mRightBottomCornerRadius * 2 - mArrowHeight, mBubbleHeight - mRightBottomCornerRadius * 2, mBubbleWidth - mArrowHeight, mBubbleHeight), 0, 90, false);
        mClipPath.lineTo(mLeftBottomCornerRadius, mBubbleHeight);
        mClipPath.arcTo(new RectF(0, mBubbleHeight - mLeftBottomCornerRadius * 2, mLeftBottomCornerRadius * 2, mBubbleHeight), 90, 90, false);
        mClipPath.lineTo(0, mLeftTopCornerRadius);
        mClipPath.arcTo(new RectF(0, 0, mLeftTopCornerRadius * 2, mLeftTopCornerRadius * 2), 180, 90, false);
        mClipPath.close();
    }
    ...
    private void createBottomArrowPath() {
        ...
        mClipPath.arcTo(new RectF(mBubbleWidth - mRightBottomCornerRadius * 2, mBubbleHeight - mRightBottomCornerRadius * 2 - mArrowHeight, mBubbleWidth, mBubbleHeight - mArrowHeight), 0, 90, false);
        ...
        mClipPath.arcTo(new RectF(0, mBubbleHeight - mLeftBottomCornerRadius * 2 - mArrowHeight, mLeftBottomCornerRadius * 2, mBubbleHeight - mArrowHeight), 90, 90, false);
        mClipPath.lineTo(0, mLeftTopCornerRadius);
        mClipPath.arcTo(new RectF(0, 0, mLeftTopCornerRadius * 2, mLeftTopCornerRadius * 2), 180, 90, false);
        mClipPath.close();
    }
    ...
    private float getArrowCenter() {
        final float baseLine = mBubbleType == BubbleType.TYPE_BUBBLE_BOTTOM || mBubbleType == BubbleType.TYPE_BUBBLE_TOP ? mBubbleWidth : mBubbleHeight;
        final float ratioForPosition = mArrowType == PositionType.TYPE_POSITION_LEFT ? 1 : (mArrowType == PositionType.TYPE_POSITION_CENTER ? 0 : -1);
        final float ratioFor = mBubbleType == BubbleType.TYPE_BUBBLE_LEFT || mBubbleType == BubbleType.TYPE_BUBBLE_BOTTOM ? 1 : -1;
