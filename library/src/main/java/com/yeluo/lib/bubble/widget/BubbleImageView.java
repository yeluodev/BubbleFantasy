...
public class BubbleImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setClipPathCreator(new ClipPathCreator() {
            @Override
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mBubbleType = typedArray.getInt(R.styleable.BubbleFantasy_bf_bubbleType, BubbleType.TYPE_BUBBLE_BOTTOM);
        mArrowType = typedArray.getInt(R.styleable.BubbleFantasy_bf_arrowType, PositionType.TYPE_POSITION_CENTER);
